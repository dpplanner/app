...
class _ColorSelectorState extends State<ColorSelector> {
  static const double circleSize = ColorCircle.circleSize;
  ...
  Color get selectedColor {
    if (selectedIndex == 0) {
      return ReservationColors.reservationColors.first; // 첫 번째 더미 색상 선택 시 첫 번째 실제 색상 반환
    } else if (selectedIndex == colors.length - 1) {
      return ReservationColors.reservationColors.last; // 마지막 더미 색상 선택 시 마지막 실제 색상 반환
    } else {
